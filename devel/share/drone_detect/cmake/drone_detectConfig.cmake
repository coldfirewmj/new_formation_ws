...
if("TRUE" STREQUAL "TRUE")
  set(drone_detect_SOURCE_PREFIX /home/wmj/new_formation_ws/src/planner/drone_detect)
  set(drone_detect_DEVEL_PREFIX /home/wmj/new_formation_ws/devel)
  ...
  set(drone_detect_INSTALL_PREFIX /home/wmj/new_formation_ws/install)
...
if(NOT "/home/wmj/new_formation_ws/src/planner/drone_detect/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/opencv;/usr/include " STREQUAL " ")
  set(drone_detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/wmj/new_formation_ws/src/planner/drone_detect/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/opencv;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'drone_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wmj/new_formation_ws/src/planner/drone_detect/${idir}'.  ${_report}")
    endif()
    _list_append_unique(drone_detect_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libopencv_calib3d.so.3.4.16;/usr/local/lib/libopencv_core.so.3.4.16;/usr/local/lib/libopencv_dnn.so.3.4.16;/usr/local/lib/libopencv_features2d.so.3.4.16;/usr/local/lib/libopencv_flann.so.3.4.16;/usr/local/lib/libopencv_highgui.so.3.4.16;/usr/local/lib/libopencv_imgcodecs.so.3.4.16;/usr/local/lib/libopencv_imgproc.so.3.4.16;/usr/local/lib/libopencv_ml.so.3.4.16;/usr/local/lib/libopencv_objdetect.so.3.4.16;/usr/local/lib/libopencv_photo.so.3.4.16;/usr/local/lib/libopencv_shape.so.3.4.16;/usr/local/lib/libopencv_stitching.so.3.4.16;/usr/local/lib/libopencv_superres.so.3.4.16;/usr/local/lib/libopencv_video.so.3.4.16;/usr/local/lib/libopencv_videoio.so.3.4.16;/usr/local/lib/libopencv_videostab.so.3.4.16;/usr/local/lib/libopencv_viz.so.3.4.16")
