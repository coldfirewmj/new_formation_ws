...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/wmj/new_formation_ws/src/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/wmj/new_formation_ws/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/wmj/new_formation_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wmj/new_formation_ws/src/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
