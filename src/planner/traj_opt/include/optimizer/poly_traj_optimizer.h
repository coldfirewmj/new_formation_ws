...
namespace ego_planner
{
  ...
  private:
    ...
    double wei_formation_;                                        // formation weght
  ...
  public:
    ...
    std::vector<int> drone_formation_id_;
    ...
    void set_formation(std::vector<int> to_id)
    {
      drone_formation_id_=to_id;
      // drone_formation_=formation_.col(from_id);
      // formation_.col(from_id)=formation_.col(to_id);
      // formation_.col(to_id)=drone_formation_;
    }
