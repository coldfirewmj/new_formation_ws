...
namespace ego_planner
{
  ...
  private:
    ...
    Hungarian hun_;
    map<int,Eigen::Vector3d> pos_map;
    ...
    // int formation_num_;
    Eigen::MatrixXd formation_pos_;
    Eigen::Vector3d drone_formation_pos_;
    ...
    void followtrajCallback(const car_msgs::TrajectoryPtr &msg);
