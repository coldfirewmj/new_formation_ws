...
class MsgMINCO:public BaseMsg<traj_utils::MINCOTrajPtr,traj_utils::MINCOTraj,BUF_LEN_SHORT>
{
private:
    /* data */
public:
    ...
    int serialize(const traj_utils::MINCOTrajPtr &msg)
    {
        char *ptr = send_buf_;
    ...
    int deserialize(traj_utils::MINCOTrajPtr &msg)
    {
        char *ptr = recv_buf_;
